...
public class InstanceImpl extends ReferenceImpl implements Instance {
		...
		if (instanceType != null && instanceType.eIsProxy()) {
			...
			if (instanceType != oldInstanceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityDiagramPackage.INSTANCE__INSTANCE_TYPE, oldInstanceType, instanceType));
			}
		}
		return instanceType;
	}
	...
	public void setInstanceType(InstanceType newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramPackage.INSTANCE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
