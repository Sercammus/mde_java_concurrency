...
public class BasicModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicModelPackage.THREAD: {
				umlad2javacc.basicmodel.BasicModel.Thread thread = (umlad2javacc.basicmodel.BasicModel.Thread)theEObject;
	 ...
	 * @generated
	 */
	public T caseThread(umlad2javacc.basicmodel.BasicModel.Thread object) {
		return null;
	}
