...
public abstract class ActivityImpl extends MinimalEObjectImpl.Container implements Activity {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate SEARCH_FOR_JOIN_BIG_INTEGER_ELIST__EINVOCATION_DELEGATE = ((EOperation.Internal)BasicModelPackage.Literals.ACTIVITY___SEARCH_FOR_JOIN__BIGINTEGER_ELIST).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_REACHABLE_ACTIVITIES_ELIST__EINVOCATION_DELEGATE = ((EOperation.Internal)BasicModelPackage.Literals.ACTIVITY___GET_REACHABLE_ACTIVITIES__ELIST).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case BasicModelPackage.ACTIVITY___SEARCH_FOR_JOIN__BIGINTEGER_ELIST:
				return SearchForJoin((BigInteger)arguments.get(0), (EList<Activity>)arguments.get(1));
			case BasicModelPackage.ACTIVITY___GET_REACHABLE_ACTIVITIES__ELIST:
