...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ActivityDiagram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityDiagramExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ActivityDiagramPackage.eNS_URI, 
			 ActivityDiagramPackage.eINSTANCE);
