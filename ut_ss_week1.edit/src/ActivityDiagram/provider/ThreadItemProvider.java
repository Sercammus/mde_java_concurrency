		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thread_daemon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thread_daemon_feature", "_UI_Thread_type"),
				 ActivityDiagramPackage.Literals.THREAD__DAEMON,
				 true,
				 false,
				 false,
	...
	protected void addActivityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thread_activity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thread_activity_feature", "_UI_Thread_type"),
				 ActivityDiagramPackage.Literals.THREAD__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivityDiagramPackage.Literals.THREAD__NAME,
				 true,
				 false,
				 false,
