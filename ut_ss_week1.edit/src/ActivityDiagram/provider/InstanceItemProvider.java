...
/**
 * This is the item provider adapter for a {@link ActivityDiagram.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider extends ReferenceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_instanceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_instanceType_feature", "_UI_Instance_type"),
				 ActivityDiagramPackage.Literals.INSTANCE__INSTANCE_TYPE,
				 true,
				 false,
				 true,
				 null,
