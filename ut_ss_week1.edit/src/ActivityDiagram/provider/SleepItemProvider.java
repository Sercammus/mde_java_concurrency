...
/**
 * This is the item provider adapter for a {@link ActivityDiagram.Sleep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SleepItemProvider extends LinearActivityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivityDiagramPackage.Literals.SLEEP__DURATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Sleep)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Sleep_type") :
			getString("_UI_Sleep_type") + " " + label;
	}
